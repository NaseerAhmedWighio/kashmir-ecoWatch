...
export function Badge({ children, variant = 'default', size = 'md', className, onClick }: BadgeProps) {
  const variants = {
    ...
    success: 'bg-emerald-100 dark:bg-emerald-900/30 text- emerald-500 dark:text-emerald-400',
    ...
    stable: 'bg-emerald-100 dark:bg-emerald-900/30 text- emerald-500 dark:text-emerald-400',
